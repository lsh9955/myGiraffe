...
> GCP의 Vision에게 인식시키는 API 활용 부분은 생략하고, 어떤 로직을 사용하는지 적겠습니다
> 
> 
> 아래의 코드는 Microservice화한 Vision 코드이다.
> 
- 코드 상세
...
> 로직 상에서 벌레는 과일보다 우선한다.
> 
> 
> 즉, 과일과 벌레가 함께 잡히면 과일이 아니라 벌레로 인식된다
> 
> ![Untitled](Untitled%2022.png)
> 
> ![Untitled](Untitled%2023.png)
> 
>  → 태그에 Fruit 와 Insect가 동시에 있어서 Insect를 반환했다.
> 

# 2. 내가 좋아하는게 뭘까?

### 2 - 1. 정해진 목록에서 그림을 그려보자
